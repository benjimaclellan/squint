...
#%%
from beartype.typing import Literal, Sequence, Union, Optional, Type

from beartype import beartype
from beartype.door import is_bearable

from squint.ops.base import Block, WiresTypes, AbstractGate, AbstractChannel
from squint.ops import dv, fock
...
def _chunk_pairs(
    x: tuple[int, ...], 
    periodic: bool = False
) -> tuple[tuple[tuple[WiresTypes, WiresTypes], ...], tuple[tuple[WiresTypes, WiresTypes], ...]]:
    """
