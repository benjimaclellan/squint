...
def test_pure_state_density(n: int):
    """Test that density matrix for a pure superposition state has correct entries."""
    ...
    # Add zero-noise channel to trigger mixed backend for density matrix output
    circuit.add(DepolarizingChannel(wires=(wires[0],), p=0.0))
